...
final class VisualEditorDocumentStore
{
    ...
    public static function publish(int $id, ?int $authorId = null): array
    {
        ...
        $id2 = (self::revisions())->publish(self::OWNER, $id, $authorId);
    ...
    {
        return (self::revisions())->listForOwner(self::OWNER, $id, $limit);
    }

    private static function revisions(): RevisionStore
    {
